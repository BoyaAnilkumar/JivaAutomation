...
public class FabricLiabilityDetails_Steps {
	...
	public void click_on_Fabric_liability_details_in_menu() {
		FLDP.click_on_Fabric_liability_details_in_menu();
	}
	
	@Then("^Verify that user navigated to fabric liability details screen$")
	public void Verify_that_user_navigated_to_fabric_liability_details_screen() {
	...
	public void click_on_add_liability_details_button_to_navigate_to_the_add_fabric_liability_details() {
		FLDP.click_on_add_liability_details_button_to_navigate_to_the_add_fabric_liability_details();
	}
	
	@Then("^verify the Process details are displaying or not$")
	public void verify_the_Process_details_are_displaying_or_not() {
		FLDP.verify_the_Process_details_are_displaying_or_not();
	}
	
	@And("^click on Add liability details button$")
	public void click_on_Add_liability_details_button() {
		FLDP.click_on_Add_liability_details_button();
	}
	
	@When("^Enter the data in mandatory fields for liability$")
	public void Enter_the_data_in_mandatory_fields_for_liability() {
