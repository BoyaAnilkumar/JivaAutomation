...
public class Stylepage extends DriverFactory{
	...
	Utilities utilities = new Utilities();
		...
		By Tech_Pack_Cancel_button		= By.xpath("//button[text()=' Cancel']");
		By Add_Sampling_details			= By.xpath("//button[text()=' Add Sampling Details']");
		By Sample_Status				= By.xpath("//select[@formcontrolname='sampleStatusId']");
		By Change_sample_status			= By.xpath("//select[@formcontrolname='sampleStatusId']/option[text()=' Submitted']");
		...
		By Order_save_button			= By.xpath("(//button[text()=' Save'])[4]");
			...
			public void The_user_select_the_Garment_Process() throws Throwable{
				...
				public void Enter_the_data_in_expected_order_qty_field() throws Throwable{
					...
					driver.findElement(ExpectedorderQty).sendKeys("4000");
					utilities.MediumWait(driver);
				}	
...
//				  driver.findElement(Back1).click();
			...
			public void click_on_column_header_to_sort()  throws Throwable{
			...
			public void Create_multiple_style_masters_details_in_pd_module() throws Throwable {
//				Random rand = new Random();
//			    int int1 = rand.nextInt(100000000);
//			    String RandomNumber= Integer.toString(int1);
//			    TaskName = "Buyerstyle " + RandomNumber;
...
//				    TaskName1 = "ExpectedorderQty" + RandomNumber1;
			    utilities.webDriverWait(driver, Add);
			    driver.findElement(Add).click();
			    utilities.MinimumWait(driver);
			    
			    driver.findElement(PDMerchant).sendKeys("Phani");
			    Robot r = new Robot();
				r.keyPress(KeyEvent.VK_DOWN);
				Thread.sleep(2000);
			    ...
			    driver.findElement(Buyerfield).click();Thread.sleep(2000);
			    driver.findElement(Buyerselect).click();Thread.sleep(2000);
			    driver.findElement(Season).click();Thread.sleep(2000);
			    driver.findElement(Selectseason).click();Thread.sleep(2000);
			    driver.findElement(GarmentType).click();Thread.sleep(2000);
			    driver.findElement(selectgarmenttype).click();Thread.sleep(2000);
			    driver.findElement(garmentprocess).click();Thread.sleep(2000);
			    driver.findElement(selectgarmentprocesstype).click();Thread.sleep(2000);
			    driver.findElement(ExpectedorderQty).sendKeys("TaskName1");Thread.sleep(2000);
			    driver.findElement(Expectedorderdate).sendKeys("14032024");Thread.sleep(2000);
			    driver.findElement(save).click();
			    Thread.sleep(10000);
			    JavascriptExecutor js = (JavascriptExecutor) driver;
