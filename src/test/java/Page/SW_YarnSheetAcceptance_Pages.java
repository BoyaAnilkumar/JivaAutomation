...
public class SW_YarnSheetAcceptance_Pages extends DriverFactory{
	...
	By Yarn_sheet_Accept = By.xpath("//button[text()=' Accept Yarn Sheet']");
	By submit_popup = By.xpath("//button[text()='Submit']");
	...
	public void click_on_Accept_yarn_sheet() throws Throwable {
		utilities.webDriverWait(driver, Yarn_sheet_Accept);
		driver.findElement(Yarn_sheet_Accept).click();
		utilities.MinimumWait(driver);
		utilities.webDriverWait(driver, submit_popup);
		driver.findElement(submit_popup).click();
