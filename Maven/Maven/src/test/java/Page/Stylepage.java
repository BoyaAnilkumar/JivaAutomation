...
public class Stylepage extends DriverFactory{
	...
	Utilities utilities = new Utilities();
		...
		By Successfull =By.xpath("//h2[text()='Style Master Added Successfully']");
...
//					driver.get("Style Master Added Successfully");
//					WebElement headerElement = driver.findElement(By.xpath("Successfull"));
//
//			        // Get the actual text from the element.
//			        String actualHeaderText = headerElement.getText();
//
//			        // Print the header message to the console.
//			        System.out.println("Displayed Header Message: " + actualHeaderText);
//				
					
					String headerMessage = this.Successfull.toString();
					System.out.println("Displayed Header Message: " + headerMessage);
				}
