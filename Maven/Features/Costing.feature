...
Feature: Title of your features
  ...
  Scenario: Creating the Costing Version
    ...
    Given Enter Garment Cutting Cost value Computer Embriodiery
    Given Enter No of Stiches
    Given Enter Rate
    Given Enter Overhead
    Given Enter Addl Charges Adda Embriodiery
    Given Enter Adda Hours
    Given Enter Adda Rate
    Given Enter Adda Overhead Manual Embriodiery
    ...
    Given Enter the Washing Cost1 testing and inspection
    ...
    Given Enter the value in the Inspection Charges Cost field Freight And Clearance
    ...
    Given Enter the value in the Additional Buffer field TOTAL DIRECT EXPENSE
    ...
    Given Enter the value in the Price Quoted To Buyer field Submit Buttons
