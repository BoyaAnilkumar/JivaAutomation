@FeatureGroup
Feature: feature to test Jiva design Revised Yarn Sheet screen functionality

@Revised_Yarn_Sheet
Scenario Outline: Validate user click on the Revised Yarn Sheet screen in menu
...
Examples:
|Buyer       |     Season     |  Status                     |StyleOrIPO     |StyleIPO         |
|Test buyer  |     Fall       |  Yarn Sheet Acceptance      |IPO1806        | IPO1806 / Style2|

@Revised_Yarn_Sheet
Scenario Outline: Verify the Added New Yarn Sheet data is displayed in the Grid
Given User navigates to Login page
Then user enter the Username and password
And User click on the signIn
...
And Click on the Submit to yarn team button
Examples:
|  StyleOrIPO|BaseSize |percentage  |Color     |
|   IPO1806  |8        |3           |Black     |
...
|   IPO1806  |  check | Is Nominated?| Anil kumar |Acrylic Nylon |  80% acrylic 20% nylon|Shell    | Almond   | 5       |4           |2         |4      |6      |     2|3  |4       |4         |5|
...
|   IPO1806  | Main body | Green   | 8       |5         | 8        |3      |7      |   4    |5   |2        |6         |
...
Examples:
|  StyleOrIPO| Use       |  Color |BaseSize |percentage |LinkingAvg|Sizeset|Testing|Sealer |TOP|Shipment|Photoshoot|
|   IPO1806  | Main body | Blue   | 8       |5          | 4         |7      |2     |   4   |5  |2       |6         |
