...
Feature: Verifying the Revise Trim Sheet screen functionality
  ...
  |IPO8					|Trim Team				|Trim Owner		|Labels								|Main label			|Green				|4					|3						|2									|Reason1		|
  ...
  |6529R				|Trim Team				|Trim Owner		| Embroidery trims		|Dori						|Banana				|8					|9						|6									|
  |230424				|Merchant Team		|Trim Owner		| Packaging trims			|Hanger					|Lilac				|6					|4						|10									|
