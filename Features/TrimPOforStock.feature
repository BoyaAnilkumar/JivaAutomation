@TrimPOforStockscreen
Feature: Verifying the Trim PO For Stock screen functioanlity
 ...
 @TrimPOforStock
  ...
  Then Click on the Apply button
  Then Click on the Reset button
  Given Filter by Search By Style"<Style>" 
  And Click on Filter Apply button
	
	Examples: 
  |Buyer 			|Supplier   				|Items		|Style		|
  |8 Seconds	|Tex Corp Pvt. Ltd 	|Cut dana	|Style1		|
  ...
  And Select Order Type"<OrderType>"
  Given Enter Rate "<Rate>"
  Given Enter L-short"<LShort>"
