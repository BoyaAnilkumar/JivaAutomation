...
Feature: feature to test Jiva design style master screen functionality
  I want to create a new style and link that style order with the costing version where order qty should be same
  ...
  @SortingGridcolumns
  Scenario: Click on each column to sort the data in ascending and descending order
    When click on column header to sort
  ...
  @AddStyleDetails
  Scenario: Add Style details by clicking on the style number
